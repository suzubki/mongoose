...
const connect = () => __awaiter(void 0, void 0, void 0, function* () {
    yield mongoose_1.default.connect(`mongodb+srv://${database.MONGO_DB_USER}:${database.MONGO_DB_PASSWORD}@${database.MONGO_DB_HOST}/${database.MONGO_DB_NAME}?retryWrites=true&w=majority`);
});
exports.db = {
    connect,
};
